...
foreach($result as $row){
    ...
    <div class="comment-body_content">
      <header><a href = "#" class ="comment-body_link"><b>'.$row->sender_name.'</b></a>
  ...
  if($countReplies>0){
    ...
    <ul class="replies">
     <li class ="comment-body">
         ...
         <!--end of image avatar-->
          <div class="comment-body_content">
           <header><a href = "" class ="comment-body_link"><b>'.$row->sender_name.'</b><i class ="fa fa-reply  fa-flip-horizontal"></i><span class ="replies_to"><b>'.$theName.'</b></span></a>
             <span class ="comment-body_date"><i class ="fa fa-circle"></i>posted: '.$row->created_at.'</span>
           </header>
           <p>'.$row->comment_body.'</p>
           <button type ="button" onclick="clickReply(this.id)" class ="comment-body__reply-button reply" 
