<?php?>
    ...
    <!--price cards-->
    <div class="heading-tertiary">Select Type of Ad</div>
       ...
       <div class="price_card">
           ...
           <div class="price_card__option">
               <ul>
                   ...
                   <li><i class="fa fa-check price-li" ></i>Will be listed in the free section for two weeks</li>
                   <li><i class="fa fa-check price-li"></i>Best option for beginners</li>
               </ul>
           </div>
   
           <a class="desc_price" href="index.php?page=content-form">Free Ad</a>
   ...
   <!--end of free add-->
       ...
       <div class="price_card">
           ...
           <a class="desc_price" href="index.php?page=content-form">Standard Ad</a>
   ...
   <!--end of standard add-->
       ...
       <div class="price_card">
           ...
           <a class="desc_price" href="index.php?page=content-form">Premium Ad</a>
