...
<div class="heading-tertiary">Enter Your Own Category Subcategory and Occupation</div>
   ...
   <form method="POST" name="multiplesub" id="multiplesub" class="profile-form" action="<?php echo BASE_FLEX?>php/add-post.php" enctype="multipart/form-data">
     ...
     <label for="post_title" id="ent_new" >label</label>
     </div>
     </div>
  ...
  <div class="categories" id="job_sub_category">
       ...
       <div class="label-style profile-form_left-select" id="ent_new_sub">
       <label for="post_title" class="msg_sub" >Enter New subcategory</label>
       <input type="text" class="input-style" name="new_subcategory" id="new_subcategory" value="" placeholder="enter new subcategory" autocomplete="off">

       <button type="submit" id="submit_subcategory" name ="submit_subcategory" class="checkout_button hidden">Enter</button>
     </div>
  ...
  <<!-- div class="categories" id="job_occupation_title">
       ...
       <div class="label-style profile-form_left-select" id="ent_new_occ">
       <label for="post_title" class="msg_occ">Enter New Occupation</label>
       <input type="text" class="input-style" name="new_occupation" id="new_occupation" value="" placeholder="enter new occupation" autocomplete="off">
       <button type="submit" id="submit_occupation" name ="submit_occupation" class="checkout_button hidden">Enter</button>
